class PagesController < ApplicationController
  ...
  def about
    ...
    @EXPERIENCES = [
      ...
      { title: "A Signature Style, Refined Over Time", description: "My photography style has grown organically over the years, shaped by countless stories and moments of love", icon: "check" },
